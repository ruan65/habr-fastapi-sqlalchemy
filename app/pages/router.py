...
from app.students.router import get_all_students_for_front, get_student_by_id
...
async def get_students_html(request: Request):
    return templates.TemplateResponse(
        name="register_form.html", context={"request": request}
    )
...
async def get_students_html(request: Request):
    return templates.TemplateResponse(
        name="login_form.html", context={"request": request}
    )
